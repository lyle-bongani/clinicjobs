    ...
    <div className="w-full px-4 sm:px-6">
      ...
      <div className="bg-gray-100 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 justify-center items-center">
        {offers.map((offer, idx) => (
          <Reveal key={offer.title} variant="up" delayMs={idx * 120}>
            <div
              className="group bg-white rounded-xl shadow w-full md:w-64 lg:w-72 max-w-xs h-96 flex flex-col anim-card-lift"
            >
              ...
              <div className="relative h-1/2 flex flex-col items-center justify-center p-4 pt-4">
                <div className="absolute left-1/2 -translate-x-1/2 -top-6 z-20">
                  <img src={offer.icon} alt="icon" className="w-20 h-20 rounded-full shadow-lg anim-icon-bump" />
                </div>
