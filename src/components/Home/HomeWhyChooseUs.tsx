...
const HomeWhyChooseUs: React.FC = () => (
  <section className="w-full py-12 bg-white">
    <div className="w-full px-4 sm:px-6 mx-auto bg-gray-100 rounded-2xl md:px-12 py-8 flex flex-col md:flex-row items-center justify-center gap-10">
      ...
      {/* Right: Content */}
      <div className="w-full md:flex-1 max-w-[420px] md:max-w-[480px] mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center justify-center !items-center !justify-center gap-4 md:gap-6 w-full">
          {features.map((feature, idx) => (
            <Reveal key={feature} variant="right" delayMs={idx * 120}>
              <div
                className="group flex flex-col items-center justify-center !items-center !justify-center bg-white rounded-xl shadow px-5 md:px-6 py-4 gap-2 md:gap-4 w-full max-w-[420px] md:max-w-[480px] mx-auto text-center !text-center anim-card-lift"
              >
